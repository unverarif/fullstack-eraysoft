...
import partners from '../json/plustek_partners'
import ozellikler from '../json/plustek_ozellikler'
...
const Kimlik = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:3000/idscanner')
          .then(response => {
    ...
    <div className='bg-gray-100'>
        ...
        <div className='container mx-auto max-w-[1240px]'>
            <div className='grid grid-cols-1 lg:grid-cols-2'>
                <div>
                    <img src={idscanner} alt="" className='w-[500px] max-h-[500px] mx-auto m-4'/>
                </div>
                <div className='flex flex-col justify-start px-4'>
                    <p className='text-black text-4xl font-black py-8 m-2'>Plustek TR550 Pasaport&Kimlik Okuyucu</p>
                    <p className='text-black text-left text-lg m-2'>
